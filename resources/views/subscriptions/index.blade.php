                            ...
                            <div class="text-right">
                                @if($active)
                                    <form method="POST" action="{{ route('subscriptions.cancel', $subscription) }}">
                                        @csrf
                                        <button type="submit" class="px-3 py-2 rounded bg-red-600 text-white hover:bg-red-700 text-sm">
                                            Cancel
                                        </button>
                                    </form>
                                @else
                                    <form method="POST" action="{{ route('subscriptions.resume', $subscription) }}">
                                        @csrf
                                        <button type="submit" class="px-3 py-2 rounded bg-indigo-600 text-white hover:bg-indigo-700 text-sm">
                                            Resume
                                        </button>
                                    </form>
                                @endif
