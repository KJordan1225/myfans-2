...
@section('content')
    ...
    @include('layouts.components.sidebar')
        <div class="col-md-9">
        <h3 class="my-3">Creator Plans Create</h3>
        <hr />
        <div class="row mt-2">
            <div class="col-md-9">
...
<div class="container py-4">
    ...
    <form method="POST" action="{{ route('creator.plans.store') }}" class="card card-body shadow-sm">
        @csrf

        <div class="mb-3">
            <label class="form-label">Plan Name</label>
            <input name="name" class="form-control" value="{{ old('name') }}" required maxlength="120">
        ...
        <div class="row g-3">
            <div class="col-md-4">
                ...
                <input name="price" type="number" min="1" step="0.01" class="form-control" value="{{ old('price', 4.99) }}" required>
            ...
            <div class="col-md-4">
                ...
                <select name="interval" class="form-select" required>
                    @foreach(['day','week','month','year'] as $i)
                        <option value="{{ $i }}" @selected(old('interval','month')===$i)>{{ ucfirst($i) }}</option>
                    @endforeach
                </select>
            ...
            <div class="col-md-4">
                ...
                <input name="currency" class="form-control" value="{{ old('currency','usd') }}" maxlength="3" required>
